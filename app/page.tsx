  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center" style={{ position: 'relative', background: '#FDFBF8' }}>
      ...
      {!showForm ? (
        ...
        <p style={{ position: 'absolute', zIndex: 1, top: 'calc(50% + 110px)', fontFamily: '"Courier New", Courier, monospace', fontSize: 18, color: '#3a3a3a', letterSpacing: '0.05em', textAlign: 'center' }}>
