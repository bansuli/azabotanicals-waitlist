...
export default function Home() {
  return (
    <div className="w-screen h-screen flex items-center justify-center" style={{ position: 'relative', background: '#FDFBF8' }}>
      ...
      {/* Button — below logo */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/waitlist-button.png" alt="Join Waitlist" style={{ width: 600, cursor: 'pointer', position: 'absolute', top: 'calc(50% + 10px)', left: 'calc(50% + 40px)', transform: 'translateX(-50%)', zIndex: 1 }} />
    </div>
  )
}
